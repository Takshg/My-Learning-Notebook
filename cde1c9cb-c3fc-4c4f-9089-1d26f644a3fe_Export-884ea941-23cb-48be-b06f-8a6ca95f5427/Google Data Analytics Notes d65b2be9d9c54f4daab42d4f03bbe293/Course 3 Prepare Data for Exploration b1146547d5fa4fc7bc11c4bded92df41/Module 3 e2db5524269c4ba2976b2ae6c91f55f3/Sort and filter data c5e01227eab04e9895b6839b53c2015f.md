...
- **Data Filtering:**
    - Used to isolate specific information by hiding irrelevant data.
    - Simplifies spreadsheets by showing only the needed information.
    - Example: Filtering to see only sales reps who worked with a particular product.
- **Data Sorting:**
    - Arranges data in a meaningful order for easier analysis and visualization.
    - Can be done in ascending/descending order, alphabetically/numerically.
    - Can be applied to entire spreadsheets or specific columns/tables.
    - Multiple criteria sorting is possible (e.g., sorting by city and then state).
    - Useful for viewing data in a specific order or finding specific information.
- **Benefits of Sorting and Filtering:**
    - Customize data presentation.
    - Organize data for focused analysis.
    - Zoom in on relevant information.
    - Improve data understanding and visualization.

### **Definitions**

- **Sorting:** Arranging data in a specific order (e.g., alphabetical, numerical).
- **Filtering:** Hiding irrelevant data to focus on specific information.
- **Data Analyst:** A professional who analyzes data to extract insights and solve problems.
- **Spreadsheet:** A software application used to organize and analyze data in rows and columns.

### **Additional Notes**

- The video emphasizes the importance of sorting and filtering for data analysis.
- These tools help data analysts focus on relevant information and make better use of large datasets.
- The video provides examples of how to use sorting and filtering in a spreadsheet.

### **Real-Life Examples**

- **Sales:** A sales manager could use filtering to see only sales data for a specific product or region.
- **Finance:** A financial analyst could use sorting to see a company's expenses in descending order of amount.
- **Marketing:** A marketing researcher could use filtering to see only data from a specific demographic group.
...
[student-performance-dataCSV File](https://d3c33hcgiwev3.cloudfront.net/872DBsBuSm29gwbAbgpt0w_8cce29fbd82c4dd981eceffd8f14acf1_student-performance-data.csv?Expires=1716768000&Signature=IO~nAn4k0sgXKN9JIZ3MW7FLWdJDDGx5sJ~PbgzJYR7RN8sQ1Tp1Sylh1i2NaS4IDSKtoL~SOf8xXOrgbT5UHisS1qXVlv-AWc7kD7hqlnJqJ3UNMtoAr9KQV30LG368tEh57qoPE~b-y7Ba9AwgClXgi6aREewyD0mSkRv-DNs_&Key-Pair-Id=APKAJLTNE6QMUY6HBC5A)
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/_gCpDlF-Qa2AqQ5RfoGtAg_d6b37c10ae4e42f190c9bb8ed2b223f1_Screenshot-2021-06-30-1.49.03-PM.png?expiry=1716768000000&hmac=lwnzMIuftxyjyfMYY9PRlY2pkp8YrPBsR0UC5-2oTH0)
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/Po-He3gMQ2uPh3t4DENrIQ_f52843d9326040aaba590f4d313d2ff1_Screenshot-2021-06-30-1.50.45-PM.png?expiry=1716768000000&hmac=uEn0-37FE7X9tgkpAqG_jrmDjEKHVFacZPiSKGP2xOk)
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/gnTZwGB1TkG02cBgdY5B0A_5052e99197174e5ea2eac58281f06af1_Screenshot-2021-06-30-1.54.24-PM.png?expiry=1716768000000&hmac=hr6cBgotFuOHfvsys-JPvRrtwJi_9F0TaiwWu8JGvX8)
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/0fE5q-flR8exOavn5VfHIQ_08991a8131f3443c9b0355f1654dd0f1_Screenshot-2021-06-30-1.55.58-PM.png?expiry=1716768000000&hmac=lHqu3fC3gk8PR4Kw-k6JiSLa0YNItDVPsHwcyH0OLII)
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/seFzo9qvQ82hc6Par8PNiA_348dfa929efe43158aa59ed284c6c1f1_Screenshot-2021-06-30-2.03.13-PM.png?expiry=1716768000000&hmac=ua9fQawHyk5H7uhaWIynwn7LqatwXoFU49P-KS0iLXI)

4. Then, click **OK**. Now, your sheet shows all the blank rows in the **reason** column.

![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/0XRu3qu6TtG0bt6ruj7RGg_51908c44aad74f98b41679504d7a42f1_Screenshot-2021-06-30-2.04.03-PM.png?expiry=1716768000000&hmac=4Ccgl_zXFNLseM1HvAdJAZXzQgoxmlL_KcAm7aTXHks)
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/O36TIbBfROi-kyGwX7To9Q_0ac759cce591497fb45f61343f29fdf1_Screenshot-2021-06-30-2.07.34-PM.png?expiry=1716768000000&hmac=kyxF5A8PQFnq_B-iPs7NuOFg9Ye8udMIK9DpN17kArs)
...
4. Fill in the popup window for the **none** value. Next to **Find**, enter **none.** Next to **Replace with**, enter **0**. Check the box next to **Match entire cell contents**.

![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/RNx9SLKdQe6cfUiynVHuwg_0eefb614e58142beb1e75bd17d78a2f1_Screenshot-2021-06-30-2.08.38-PM.png?expiry=1716768000000&hmac=CJKShH-z1CTOT6nnWhr5h3xs95hyfavDTIZsfjh_vlE)
