...
- **Stakeholders:** People who have invested time, interest, and resources into a project. They hold stakes in what you're doing and need your work to perform their own tasks.
- **Importance of Stakeholder Expectations:** Understanding stakeholder expectations helps you:
    - **Focus on the project's goal:** Align your work with their needs.
    - **Communicate effectively:** Build trust and confidence in your work.
    - **Move the project forward:** Collaborate effectively with your team.
- **Identifying Stakeholder Needs:** Consider the project's objective, their specific needs, and any challenges or concerns they might have.
- **Example:** Analyzing employee turnover for the HR department.
    - **Stakeholders:** VP of HR, Project Manager, HR Administrators, other Data Analysts.
    - **Needs:** Identify patterns in employee turnover, connect to productivity and engagement.
    - **Communication:** Regular updates, feedback on sharing information with the VP.
    - **Outcome:** Implement manager check-ins to reduce turnover.

**Definitions:**

- **Stakeholder:** A person or group with an interest in a project.
- **Project Objective:** The specific goal or outcome of a project.
...
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/XAuqDNu8SSqLqgzbvMkqfA_34dc6616b07f453fb9cbd955008544d9_DA_C2M4L2R1.png?expiry=1716508800000&hmac=cv6Y6B2wKan75Xk9RdMTWCYyJXIm-eZHh0qvCE9tMcQ)
...
- **Importance of Stakeholder Balance:** Finding the right balance between stakeholder needs and team member needs is crucial for successful data-driven decision making.
- **Staying Focused on the Objective:** Amidst competing needs and opinions, focusing on the project's objective is essential.
- **Three Key Questions to Stay on Track:**
...
- **Primary Stakeholder:** The individual or group with the most significant interest in the project's success.
- **Secondary Stakeholder:** Individuals or groups with a lesser but still important interest in the project.
- **Data Analyst:** A professional who collects, analyzes, and interprets data to inform decision-making.

**Summary:**

This video emphasizes the importance of staying focused on the project's objective while balancing stakeholder needs. It introduces three key questions that data analysts can ask themselves to ensure they remain on track:

1. **Who are the primary and secondary stakeholders?** Identifying stakeholders and their goals helps analysts prioritize their work and ensure everyone's needs are considered.
2. **Who is managing the data?** Understanding who manages different data sets within the project allows for efficient collaboration and avoids duplication of effort.
3. **Where can you go for help?** Knowing who to turn to for assistance when encountering obstacles ensures timely resolution and keeps the project moving forward.

By addressing these questions, data analysts can effectively manage stakeholder expectations, utilize data efficiently, and seek help when needed, ultimately contributing to successful data-driven decision-making.
